...
const usernameNotExists = async (db: Database, v: string) => {
...
export const createUserValidator = vine.compile(
  vine.object({
    username: vine.string().maxLength(55).unique(usernameNotExists),
...
export const updateUserValidator = vine.compile(
  vine.object({
    username: vine.string().maxLength(55).unique(usernameNotExists).optional(),
